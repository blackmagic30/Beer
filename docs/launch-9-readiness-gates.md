...
- `beermap-source-evidence` is private, has no direct browser object policies, and is reachable only through authorized server APIs and short-lived admin review URLs.
