...
describe("missions page", () => {
  it("supports location-aware missions and search-to-submit handoff", () => {
    ...
    expect(html).toContain('trackEvent("search_performed"');
    expect(html).toContain('source: "area_lookup"');
    expect(html).toContain('trackEvent("location_permission_requested"');
    expect(html).toContain('trackEvent("location_permission_granted"');
    expect(html).toContain('trackEvent("location_permission_denied"');
    ...
    expect(html).toContain('id="retryMissionsButton"');
    expect(html).toContain("new AbortController()");
    expect(html).toContain("missionRequestController?.abort()");
    expect(html).toContain("Release mission");
    expect(html).toContain('method: "DELETE"');
    expect(html).toContain("mission.reservationExpiresAt");
    expect(html).toContain('<option value="saved">My saved areas</option>');
    expect(html).not.toContain('value="most_requested"');
    expect(html).not.toContain('value="high_demand"');
    expect(html).toContain("const INITIAL_MISSION_COUNT = 5");
    expect(html).toContain("const MISSION_PAGE_SIZE = 5");
    expect(html).toContain("const MISSION_SERVER_PAGE_SIZE = 50");
