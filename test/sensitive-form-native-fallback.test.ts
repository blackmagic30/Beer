...
const EXPECTED_STATIC_FORMS = [
  ...
  "auth/callback.html#callbackIdentityConfirmationForm",
...
const SUBMIT_HANDLER_EVIDENCE: Readonly<Record<string, string>> = {
  ...
  "auth/callback.html#callbackIdentityConfirmationForm": 'identityConfirmationForm.addEventListener("submit"',
